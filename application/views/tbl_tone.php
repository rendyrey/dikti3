  ...
  <div class="contentpanel">
    ...
    <div class="panel">
      <div class="panel-heading">
        <?php if($tone==1){ ?><p class="text primary"><h3>Tabel berita dengan tone Positif</h3></p> <?php } ?>
        <?php if($tone==-1){ ?><p class="text primary"><h3>Tabel berita dengan tone Negatif</h3></p> <?php } ?>
        <?php if($tone==0){ ?><p class="text primary"><h3>Tabel berita dengan tone Netral</h3></p> <?php } ?>
      </div>
          ...
          <table id="dataTable1" class="table table-bordered table-striped-col">
            ...
            <tbody>
              ...
              for($i=0;$i<$jml_isi_berita;$i++){
                ...
                echo "<tr>";
                echo "<td>".$j."</td>";
                echo "<td align='left'><span class='glyphicon glyphicon-time' style='margin-right:5px;'></span>".$tgl_berita[$i].", ".$jam_berita[$i];
                echo "<br>";
                echo "<h4>".$judul[$i]."&nbsp;"."</h4>";
                echo "<button class='btn btn-info btn-xs'>Topik: <i><b>".$nama_sub_topik[$i]."</b></i></button><br>";
