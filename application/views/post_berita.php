  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
      <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">Post Berita</li>
      </ol>

      <div class="panel">
            <div class="panel-heading">
              <h4 class="panel-title">Posting Berita</h4>
            ...
            <?php }?>
              <form action="<?php echo site_url('Berita/post');?>" method=post id='form_berita' enctype="multipart/form-data">
                Jenis Berita:
                <label class="rdiobox">
                  <input type="radio" name="jenis_berita" checked="" value="Kemenristekdikti">
              ...
              <div class="form-group">
                <input name='judul' type="text" placeholder="Judul Berita" class="form-control" required>
              </div>
              <div class="form-group">
                <select name='id_media' id="select1" class="form-control" style="width: 100%" data-placeholder="Sumber" required>
                  ...
                  $i=0;
                    ...
                    echo "<option value='M099'>Sumber Lain</option>";
                   ?>
        ...
        <div class="form-group">
          ...
          <input type="file" name="file_upload" accept="image/*, .pdf, .PDF" required>
        </div>
              ...
              <div class="input-group">
               <input type="text" name='tgl_berita' class="form-control" placeholder="Tanggal Berita" id="datepicker" required>
               <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
             </div>
             <div class="form-group" style="margin-top:30px;">
               <input name='wartawan' type="text" placeholder="Wartawan" class="form-control" maxlength="30" required>
             </div>
            ...
            <div class="form-group" style="margin-top:30px;">
              <input name='halaman' type="text" placeholder="Halaman" class="halaman form-control">
            </div>
             <div class="form-group" style="margin-top:30px;">
               <input name='link_berita' type="text" placeholder="Link Berita" class="sumber form-control" required disabled>
             </div>

             <div class="input-group">
                <span class="input-group-addon">Rp</span>
                <input type="text" class="form-control" placeholder="Ad Value" name="ad_value" id='auto_number1'>
              </div>

              <div class="input-group">
                 <span class="input-group-addon">Rp</span>
                 <input type="text" class="form-control" placeholder="News Value" name="news_value" id='auto_number2'>
               </div>
